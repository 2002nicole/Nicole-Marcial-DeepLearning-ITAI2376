...
5. Upload `kaggle.json` in the notebook when prompted.
6. Run the Kaggle download command.
...
7. Review the custom CNN results, MobileNetV2 transfer learning results, fine-tuning results, prediction visualizations, and confusion matrix.
